...
Future<void> calculateGwaAction(BuildContext context) async {
  // Get values from AppState
  List<int> unitsA = FFAppState().Unit;
  List<double> gradesA = FFAppState().Grade;

  List<int> unitsB = FFAppState().Unit1;
  List<double> gradesB = FFAppState().Grade1;
